#!/bin/bash
# Test 3: Repeat normal load - 1000 RPM for 1 minute

set -e
cd "$(dirname "$0")/.."

RESULTS_FILE="tests/test3-results.txt"
...
{
  echo "=========================================="
  echo "TEST 3: NORMAL REPEAT (1000 RPM, 1 minute)"
  echo "=========================================="
  echo "Timestamp: $(date)"
  echo ""
} | tee "$RESULTS_FILE"
...
{
  echo ""
  echo "Waiting 20 seconds for queue processing..."
} | tee -a "$RESULTS_FILE"
sleep 20
